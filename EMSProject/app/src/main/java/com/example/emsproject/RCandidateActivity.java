...
public class RCandidateActivity extends AppCompatActivity {
    ...
    private void doSubmitDetails() {
        ...
        if(rdbRC_Male.isChecked()) {gender = "Male";} else {gender = "Female";}
        ...
        DocumentReference documentReference = fStore.collection("Candidate").document(uid);
        Map<String, Object> candidate = new HashMap<>();
        candidate.put("Uid", uid);
        ...
        documentReference.set(candidate).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(RCandidateActivity.this, "Failed : " + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
}